...
/*
1.Define a class “book.MathOperation” to perform the following operation depending upon the users
choice.
...
public class MathOperation {
    public static void main(String[] args) {
        ...
        switch (n) {
            ...
            case 3 -> System.out.println("book.Cube of number " + Math.pow(n, 3));
        }
    }
}
